...
python3 .claude/skills/design-system/scripts/search-slides.py "metrics dashboard" -d layout

# Contextual recommendation
python3 .claude/skills/design-system/scripts/search-slides.py "traction slide" \
